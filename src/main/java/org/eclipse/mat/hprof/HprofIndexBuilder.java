...
//        }
    ...
    {
        String task = MessageUtil.format(Messages.HprofIndexBuilder_Parsing, new Object[]{file.getAbsolutePath()});

        SimpleMonitor monitor = new SimpleMonitor(task, listener, new int[]{500, 1500});
